<div align= "center">
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: center; color: #282d33;"> Python, AWS, Airflow, Docker를 활용한 데이터 파이프라인 구축과 자동화에 관심이 있습니다.<br></li>또한 생성형 AI와 최신 개발 도구를 적극적으로 활용하며 새로운 기술을 빠르게 학습하고 프로젝트에 적용하는 것을 좋아합니다.<br><br></li>기술을 단순히 배우는 것에 그치지 않고 실제 문제 해결에 활용하는 개발자가 되고자 합니다. </div> 
    </div>
